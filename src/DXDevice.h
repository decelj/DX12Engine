...
public:
	...
	ID3D12RootSignature* CreateRootSignature(const std::vector<D3D12_ROOT_PARAMETER1>& params, const std::vector<D3D12_STATIC_SAMPLER_DESC>& staticSamplers);
	...
	ID3D12Resource* CreateCommitedUploadResource(const D3D12_RESOURCE_DESC& desc);
